...
| B-18 | P2 | Спека обещает «порт занят → выбрать свободный», код честно отказывается. Решить, что правда: поведение или спека | анализ 2026-08-30 | open |
| B-19 | P3 | Визард клонирует роботу зашитый репозиторий (`wizard.py:30`); параметр есть, панель его не передаёт | анализ 2026-08-30 | open |
| B-20 | P3 | READ-инструменты (в т.ч. скриншот) исполняются без спроса. В standalone их прикрывает bearer, в gateway — только шлюз. Решить, нужен ли отдельный тумблер «спрашивать и на READ» | анализ 2026-08-30 | open |
